...
def create_window(theme):
    ...
    layout = [
        ...
        [sg.Text("", key="txt_Selected", font=("Helvetica", 8), size=(55, 1), background_color="light grey", text_color="black", pad=(0, 20))],
        [sg.Button("Go", key="btn_Start", size=(14, 1), font=("Helvetica", 14)),     
            sg.Button("Theme Toggle", key="tgl_Theme", size=(14, 1), font=("Helvetica", 14))]
    ]
